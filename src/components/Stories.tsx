...
export default function Stories() {
    ...
    },
  {
    ...
    full: language === 'es' ? 
      ...
      'My son is asthmatic, so I usually go to the ER. In New York he had Medicaid and it was free for him. Now, since I’m pregnant and I don’t have insurance, I haven’t gone to the doctor yet. I don’t want to get a bill. The cost of healthcare definitely stops us. I usually search Google to find clinics and call to ask which ones accept my insurance or his and if they are available. I look for reviews, if they are good, the customer service, if they treat you well, if they take care of you fast or if they take long. Wait time is important to me. I have a car, so transportation is not a problem.',
