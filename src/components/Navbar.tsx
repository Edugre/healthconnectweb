  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-[#D1FAE5] px-[5%] py-4 flex flex-col md:flex-row justify-between items-center shadow-lg z-[1000] gap-4">
      ...
      <div className="flex flex-wrap gap-4 md:gap-8 items-center justify-center">
        ...
        <div className="flex gap-2 items-center bg-white/20 px-2 py-1 rounded-full cursor-pointer transition-colors hover:bg-white/30">
          <button
            onClick={() => setLanguage('es')}
            className={`bg-transparent border-none cursor-pointer p-1 rounded-full transition-all hover:scale-110 ${
